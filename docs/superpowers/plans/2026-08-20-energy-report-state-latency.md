...
```bash
git add app/tools/energy_saving_tool.py app/prompts/energy_saving.py tests/test_energy_saving_tool.py tests/test_energy_prompt.py
git diff --cached --check
